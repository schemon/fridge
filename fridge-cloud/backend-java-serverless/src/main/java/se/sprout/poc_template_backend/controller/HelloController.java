...
public class HelloController {
    ...
    public Map<String, String> hello() {
        ...
        return Map.of("value", "greetings anonymous at " + keyValue1.getValue());
    }

    @GetMapping("/api/v1/hello/me")
    public Map<String, String> helloForUser(@AuthenticationPrincipal ExtendedPrincipal principal) {
